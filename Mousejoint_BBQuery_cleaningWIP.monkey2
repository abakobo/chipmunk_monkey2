...
Global BBR:=New Recti (-195,82,-115,1)
Global BB:=cpBBNew(BBR.Left,BBR.Bottom,BBR.Right,BBR.Top) 'top and bottom are inverted!?


Struct struct_for_callBack
 Field i:Int=15
 Field s:String="test message"
 Field d:double=12.21
End
Struct struct_for_shape
	Field f:Float=450.25
	Field str:String="shape data text test"
End
